...
function moduleRubricToStoragePayload(generated: ModuleRubric): {
  criteria: Record<string, unknown>;
  scalingRule: Record<string, unknown>;
} {
...
export async function ensureRubricVersion(
  ...
  const payload = generated
    ? moduleRubricToStoragePayload(generated)
    : { criteria: GENERIC_RUBRIC_CRITERIA, scalingRule: GENERIC_RUBRIC_SCALING_RULE };
