...
describe("admin content translation resources", () => {
  ...
  it("includes admin content workspace labels for all locales", () => {
    const requiredKeys = [
      ...
      "adminContent.startMode.import",
      "adminContent.startMode.manual",
      "adminContent.startMode.existing",
      "adminContent.select.loadContent",
      "adminContent.select.exportModule",
      "adminContent.select.duplicateModule",
      ...
      "adminContent.message.moduleDuplicated",
